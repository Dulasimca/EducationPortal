export class PathConstants {
    ...
    public static readonly Question_Bank_Delete = 'QuestionBank/Put';
    ...
    public static readonly NewsLetter_Get = 'NewsLetter/Get';
    ...
    public static readonly PollList_Get = 'PollList/Get';
